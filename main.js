...
/*
  ...
  Do NOT use link.click() here.

  The original link's onclick function
  already knows the shuffled position.

  Calling the onclick directly prevents
  the click from bouncing back through
...
/*
  Do not rebuild an already decorated card.
*/
...
/*
  Hide the original contents but KEEP
  the original <a> in the DOM.

  Its onclick function is what connects
  this card to the shuffled song.
*/
...
/*
  Position the gold line at the top
  of the visible area, accounting for
  the sticky player.
*/
...
requestAnimationFrame(() => {
  ...
  /*
    Wait another frame so the browser has
    finished laying out the newly-created
    cards before calculating their position.
  */
...
/*
  ...
  We do NOT attach another click handler
  to #draw-cards.

  index.html already owns that button.

  Instead, we watch #cards itself. When
  index.html creates the six cards, this
  observer notices them and decorates them.
*/
...
/*
  If cards already exist when main.js
  starts, decorate them without scrolling.
*/
